  ...
  return (
    <>
      ...
      flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm": ""}`}>
        ...
        <ul className={`hidden md:flex items-center gap-16 lg:gap-8
        ...
        <div className='flex items-center gap-4'>
          ...
          <a href='#contact' className='hidden lg:flex items-center gap-3
            px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contacto <Image src={assets.arrow_icon}
            alt="" className='w-3' /></a>
